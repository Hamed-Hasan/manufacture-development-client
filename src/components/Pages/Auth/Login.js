        ...
        <div className="md:flex md:items-center md:justify-center w-full mx-auto md:h-full xl:w-2/5 p-8  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white ">
          <div className="max-w-lg w-full space-y-8">
            ...
            <form 
              ...
              className="mt-8 space-y-2 md:ml-16 grid grid-cols-1 justify-items-center"
            >
              ...
              <p
                ...
                className="text-left text-sky-700 hover:underline cursor-pointer"
              >
                <small>Forget Password</small>
              </p>
              <p className="text-left ">
                <small>
                  Develop Manufacture to{" "}
