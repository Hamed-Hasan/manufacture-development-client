...
const AddOrder = () => {
  ...
  return (
    <div>
<section 
            class=" px-4 lg:px-16 overflow-hidden relative z-10" data-aos="fade-up" 
            id="contact"
        >
            <div 
                class="container"
            >
                ...
                >
                    <h2 class="text-slate-900 dark:text-gray-200 text-3xl font-bold">Add New Product</h2>
                </div>
                <div 
        ...
        >
          <Box sx={style}>
            ...
            <Typography id="modal-modal-description" sx={{ mt: 2 }}>
              Check your service go to Home page & Manage Order page &
