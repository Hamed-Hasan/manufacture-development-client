...
const ContactUs = () => {
  ...
  return (
    <div>
      <div className="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-44">
        <div
          ...
          <div className="md:flex w-full">
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              <div className="text-center mb-10">
                {/* <h1 className="font-bold text-3xl text-gray-900">SubScribe !</h1> */}
                <TypeWriterForm />
